package com.sinitsynvl.dataexam.test.config;
...
@ComponentScan("com.sinitsynvl.dataexam")
public class TestDataBaseConfig {
    ...
    private static final String PROPERTY_NAME_ENTITYMANAGER_PACKAGES_TO_SCAN = "com.sinitsynvl.dataexam.entity";
